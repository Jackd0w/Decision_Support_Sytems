...
def add_gaussian_noise(X_test):
    gaussian_noise_imgs = []
    row, col, _ = X_test[0].shape
...
gaussian_noise_imgs = add_gaussian_noise(X_test)
...
hopfield(train_files=X_train, test_files=X_test, theta=0.5,time=20000,size=(100,100),threshold=60, current_path = current_path)